...
## Audit finding 2: an IGD behind CGNAT or a double-NAT router can hand back
## its own private WAN address as the "external" address, in which case the
## mapping is real but nobody outside the LAN can reach it.
