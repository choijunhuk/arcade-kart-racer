...
signal kart_launched(kart: Node)
signal kart_hopped(kart: Node)
signal kart_contacted(kart: Node)
signal wall_impacted(kart: Node)
signal wall_head_on(kart: Node)
signal kart_landed(kart: Node, vertical_speed: float)
signal roulette_started(kart: Node)
signal roulette_ticked(kart: Node)
signal roulette_stopped(kart: Node)
