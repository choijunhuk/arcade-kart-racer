...
func _ready() -> void:
	...
	OnlineLobbyWidgets.lock_options(_driver, _drivers, "driver", save_data)
	OnlineLobbyWidgets.lock_options(_kart, _karts, "kart", save_data)
...
func _build_race_options_row() -> void:
	...
	OnlineLobbyWidgets.lock_options(_track, _tracks, "track", SaveManager.load_data())
