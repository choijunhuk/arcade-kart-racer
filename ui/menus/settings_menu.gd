...
func _connect_controls() -> void:
	...
	_connect_toggle($Panel/VBox/Tabs/Gameplay/TelemetryToggle, &"gameplay", &"telemetry_enabled")
	_connect_toggle($Panel/VBox/Tabs/Gameplay/RaceIntroToggle, &"gameplay", &"race_intro")
	_connect_toggle($Panel/VBox/Tabs/Gameplay/NameTagsToggle, &"gameplay", &"name_tags")
...
func _sync_values() -> void:
	...
	_set_toggle($Panel/VBox/Tabs/Gameplay/TelemetryToggle, &"gameplay", &"telemetry_enabled", true)
	_set_toggle($Panel/VBox/Tabs/Gameplay/RaceIntroToggle, &"gameplay", &"race_intro", true)
	_set_toggle($Panel/VBox/Tabs/Gameplay/NameTagsToggle, &"gameplay", &"name_tags", true)
